      ...
      <CardHeader className="pb-4 bg-red-50/50 dark:bg-red-950/20 border-b border-red-100/50 dark:border-red-950/30">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl font-bold tracking-tight">Kontak</CardTitle>
              <CardDescription className="text-xs font-medium">Kontak darurat & servis</CardDescription>
            </div>
          </div>
